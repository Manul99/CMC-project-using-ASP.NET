<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="captainaccountcreat.aspx.cs" Inherits="QAProject.captainaccountcreat" %>
...
<link rel="stylesheet" href="captainaccountcreat.css" />
    <title></title>
</head>
<body>
   ...
   <div class="insert border border-dark w-25">
    ...
    <form id="form1" runat="server">
        <div class="mb-3">
               ...
               <div class="label"><asp:Label ID="Label1" runat="server" Text="Captain ID"></asp:Label></div> 
           ...
           <div class="mb-3">
            ...
            <center><table>
                <tr>
                    ...
                    <td></td>
                    <td>
                         <asp:Button ID="Button2" runat="server" Text="Cancel" BackColor="Lime" />
                    </td>
                </tr>
                </table></center>
       ...
       <center><h4>update Data</h4></center><br />
        ...
        <div class="mb-3">
               ...
               <div class="label"><asp:Label ID="Label6" runat="server" Text="Captain ID"></asp:Label></div> 
           ...
           <div class="mb-3">
            ...
            <center><table>
                <tr>
                    ...
                    <td></td>
                    <td>
                         <asp:Button ID="Button4" runat="server" Text="Cancel" BackColor="Lime" />
                    </td>
                </tr>
                </table></center>
    ...
    <div class="delete border border-dark w-100">
       <center><h4>Delete Data</h4></center><br />
        ...
        <div class="mb-3">
               ...
               <div class="label"><asp:Label ID="Label11" runat="server" Text="Captain ID"></asp:Label></div> 
