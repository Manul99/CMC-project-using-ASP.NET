<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="garbagecollectingsopt.aspx.cs" Inherits="QAProject.garbagecollectingsopt" %>
...
<link rel="stylesheet" href="garbagecollectingspot.css" />
    <title></title>
</head>
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        <h1>Upload garbage collecting spot</h1>
    <div class="buttons">
        <h2>Select type</h2>
   ...
   <div class="poster border border-dark w-50">
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
         <div class="mb-3">
               <div class="label"><asp:Label ID="Label6" runat="server" Text="Title ID"></asp:Label></div> 
             <asp:TextBox ID="ID" runat="server" Width="283px"></asp:TextBox>
            </div>
            <div class="mb-3">
               <div class="label"><asp:Label ID="Label2" runat="server" Text="Title"></asp:Label></div> 
                 <asp:TextBox ID="title" runat="server" Width="283px"></asp:TextBox>
            </div>
         <div class="mb-3">
             <asp:FileUpload ID="FileUpload1" runat="server" />
            </div>
            <div class="mb-3">
               <div class="label"><asp:Label ID="Label1" runat="server" Text="Location"></asp:Label></div> 
                 <asp:TextBox ID="location" runat="server" Width="283px"></asp:TextBox>
            </div>
        </div><br /><br />
        <center><table class="tble">
                <tr>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Upload" BackColor="Lime" OnClick="Button1_Click1"/>
                        
                    </td>
                    <td></td>
                    <td>
                         <asp:Button ID="Button2" runat="server" Text="Update" BackColor="Lime" OnClick="Button2_Click" />
                    </td>
                     <td>
                         <asp:Button ID="Button3" runat="server" Text="Delete" BackColor="Lime" OnClick="Button3_Click" />
                    </td>
                </tr>
                </table></center>
    </form>
